...
//class MyParallelServer2 : public server_side::Server<P, S> {
//
//    static void parallel(ClientHandler<P, S> *clientHandler, int new_sock, bool *isRun) {
//        cout << "start" << endl;
...
//    }
//
//    static void startPar(int port, ClientHandler<P, S> *clientHandler, bool *parallelStop) {
